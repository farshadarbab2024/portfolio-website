  ...
  return (
    <section className="h-screen w-screen relative">
      ...
      >
        ...
        >
          <img
            src={
              ...
              "/images/Farshad Arbab profile picture.png"
            }
        ...
        >
          <h1
            className="block text-center font-black color-black text-[43px] mt-8 md:text-[48px]
            md:text-right lg:text-[70px]"
          >
            {websiteTexts.fullName}
          </h1>
          <span
            className="block text-center text-[#888888] text-[18px] mt-[5px] md:text-[20px]
            md:text-left lg:text-[23px]"
          >
