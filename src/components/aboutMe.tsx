function AboutMe(){
    ...
    return(
        <>
            <h2 className="font-semibold text-center color-black text-[32px]" >درباره من</h2>
            <p className="mt-[1rem] text-justify text-[26px] color-black">{aboutMeText}</p>
            <button className="border-2 border-black rounded-[0.3rem] w-[9.4rem] 
            h-[2.8rem] text-[1.3rem] mt-8 color-black">دانلود رزومه</button>
        </>
    ) ; 
} ; 
